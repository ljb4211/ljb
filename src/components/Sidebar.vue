<template>
  <el-aside width="isCollapse ? '64px' : '264px'">
    <el-menu
      ...
      >
      <div class="brand">
        <el-image style="width: 50px; height: 50px;margin-right: 10px;" :src="icconUrl" alt="logo" />
      ...
      <el-icon><component :is="resolveComponent(item.meta.icon)" /></el-icon>
...
const icconUrl=new URL('@/assets/images/机器人.png', import.meta.url).href
// 监听 isCollapse 变化，更新侧边栏宽度
